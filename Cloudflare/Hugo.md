...
![create-page.png](/create-page.png)
...
![screenshot_from_2026-03-29_11-36-56.png](/screenshot_from_2026-03-29_11-36-56.png)

4. import existing  repository
![getting-started-with-pages-1.png](/getting-started-with-pages-1.png)

![getting-started-with-pages-2.png](/getting-started-with-pages-2.png)

5. configure for hugo
![getting-started-with-pages-3.png](/getting-started-with-pages-3.png)

6. Select Domain
![getting-started-with-pages-select-domain.png](/getting-started-with-pages-select-domain.png)